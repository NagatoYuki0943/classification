...
models_list = timm.list_models(filter=["*inception_next*"], exclude_filters=[], pretrained=True)
...
model = models.inception_next.inception_next_tiny(pretrained=False, num_classes=5).to(device)
