...
models_list = timm.list_models(filter=["*inception_v3*"], exclude_filters=[], pretrained=True)
...
model = timm.create_model("inception_v3.tf_in1k", pretrained=False, num_classes=5).to(device)
