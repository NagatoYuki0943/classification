...
class ResNet101(nn.Module):
    def __init__(self, channels):
        ...
        self.__addBasicBlock(
            self.layer1, numbers=2, in_out_channels=256, middle_channels=64
        )
        ...
        self.__addBasicBlock(
            self.layer2, numbers=3, in_out_channels=512, middle_channels=128
        )
        ...
        self.__addBasicBlock(
            self.layer3, numbers=22, in_out_channels=1024, middle_channels=256
        )
        ...
        self.__addBasicBlock(
            self.layer4, numbers=2, in_out_channels=2048, middle_channels=512
        )
    ...
    def __addBasicBlock(self, layer, numbers, in_out_channels, middle_channels):
        ...
        for i in range(numbers):
            #                参数1名字必须不同,不然会被覆盖
            layer.add_module(
                f"Bottleneck{i+1}", Bottleneck(in_out_channels, middle_channels)
            )
