...
class ResNet152(nn.Module):
    def __init__(self, channels):
        ...
        self.__addBasicBlock(self.layer2, numbers=7, in_out_channels=512, middle_channels=128)
        ...
        self.__addBasicBlock(self.layer3, numbers=35, in_out_channels=1024, middle_channels=256)
