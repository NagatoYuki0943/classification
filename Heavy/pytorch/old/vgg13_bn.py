...
#     (18): BatchNorm2d(256, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)    1
#     (19): ReLU(inplace=True)
#     (20): MaxPool2d(kernel_size=2, stride=2, padding=0, dilation=1, ceil_mode=False)


#     (21): Conv2d(256, 512, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
#     (22): BatchNorm2d(512, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)    0
#     (23): ReLU(inplace=True)

#     (24): Conv2d(512, 512, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
#     (25): BatchNorm2d(512, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)    1
#     (26): ReLU(inplace=True)
#     (27): MaxPool2d(kernel_size=2, stride=2, padding=0, dilation=1, ceil_mode=False)

#     (28): Conv2d(512, 512, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
#     (29): BatchNorm2d(512, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)    0
#     (30): ReLU(inplace=True)

#     (31): Conv2d(512, 512, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
#     (32): BatchNorm2d(512, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)    1
