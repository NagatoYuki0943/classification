...
def resnext50_32x4d(pretrained=False, num_classes=1000, include_top=True):
    ...
    return resnet('resnext50_32x4d', Bottleneck, pretrained, [3, 4, 6, 3], num_classes, include_top, groups, width_per_group)
...
def resnext101_32x8d(pretrained=False, num_classes=1000, include_top=True):
    ...
    return resnet('resnext101_32x8d', Bottleneck, pretrained, [3, 4, 23, 3], num_classes, include_top, groups, width_per_group)
