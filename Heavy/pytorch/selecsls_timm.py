...
models_list = timm.list_models(["*selecsls*"], exclude_filters=[], pretrained=True)
...
model = models.selecsls.selecsls42(pretrained=False, num_classes=5).to(device)
