...
def _resnet(
            ...
            im_width=224, im_height=224, num_classes=1000,
            include_top=True):  # 顶层结构 平均池化和线性层
...
def resnet101(im_width=224, im_height=224, num_classes=1000, include_top=True):
    return _resnet(Bottleneck, [3, 8, 36, 3], im_width, im_height, num_classes, include_top)
