...
def main():
    ...
    # 图片生成器
    train_image_generator = ImageDataGenerator(horizontal_flip=True, preprocessing_function=pre_function)   # preprocessing_function 图片均值化
    ...
    def train_step(images, labels):
        ...
        # 将损失反向传播到每一个可训练变量中
        gradients = tape.gradient(loss, model.trainable_variables)              # 只更新可以训练的参数
        # 将节点误差梯度用于更新到每个节点的参数值
        optimizer.apply_gradients(zip(gradients, model.trainable_variables))    # 只更新可以训练的参数
