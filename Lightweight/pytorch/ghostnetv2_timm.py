...
models_list = timm.list_models(filter=["*ghostnetv2*"], exclude_filters=[], pretrained=True)
...
model = models.ghostnet.ghostnetv2_100(pretrained=False, num_classes=5).to(device)
