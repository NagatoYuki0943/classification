...
models_list = timm.list_models(["*efficientformer*"], exclude_filters=[], pretrained=True)
...
model = models.efficientformer_v2.efficientformerv2_s0(pretrained=False, num_classes=5).to(device)
