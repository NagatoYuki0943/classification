...
models_list = timm.list_models(filter=["*eva02*"], exclude_filters=[], pretrained=True)
...
model = models.eva.eva02_base_patch14_224(pretrained=False, num_classes=5).to(device)
