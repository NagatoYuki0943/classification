...
models_list = timm.list_models(["*resmlp*"], exclude_filters=[], pretrained=True)
...
model = models.mlp_mixer.resmlp_12_224(pretrained=False, num_classes=5).to(device)
