...
#   unbind 和 [0] [1] [2] 等价
#------------------------------------#
y1 = x.reshape(1, POSITION, 3, HEAD, CHANNEL // HEAD)   # [1, 196, 2304] -> [1, 196, 3, 12, 64]
...
#   不把3放到最前面,直接unbind
#------------------------------------#
y2 = x.reshape(1, POSITION, 3, HEAD, CHANNEL // HEAD)   # [1, 196, 2304] -> [1, 196, 3, 12, 64]
...
#   不分出3来,直接chunk
#------------------------------------#
y3 = x.reshape(1, POSITION, HEAD, CHANNEL * 3 // HEAD)  # [1, 196, 2304] -> [1, 196, 12, 192]
