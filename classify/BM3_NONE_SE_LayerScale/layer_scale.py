...
import os
from modified_model.mobilenet_v3_torchvision_layer_scale import mobilenet_v3_large
...
NUM_CLASSES = 6
PRETRAINED  = True
SAVE_PATH   = f"./checkpoints/{time.strftime('%Y%m%d-%H%M%S', time.localtime())}-mobilenet_v3_large-layer_scale"
...
if __name__ == "__main__":
    ...
    # dataset
    _, _, train_dataloader, val_dataloader = get_custom_data("./datasets/intel_origin_scenery", batch_size=BATCH_SIZE, resize=RESIZE, num_workers=8)
