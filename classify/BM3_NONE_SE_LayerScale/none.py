...
import os
from modified_model.mobilenet_v3_torchvision_without_se import mobilenet_v3_large
...
NUM_CLASSES = 6
PRETRAINED  = True
SAVE_PATH   = f"./checkpoints/{time.strftime('%Y%m%d-%H%M%S', time.localtime())}-mobilenet_v3_large-none"
