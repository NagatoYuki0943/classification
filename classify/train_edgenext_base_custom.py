...
NUM_CLASSES = 6
PRETRAINED  = True
SAVE_PATH   = f"./checkpoints/{time.strftime('%Y%m%d-%H%M%S', time.localtime())}-edgenext_base"
...
if __name__ == "__main__":
    ...
    # model
    model = models.edgenext.edgenext_base(pretrained=True, num_classes=NUM_CLASSES)
