...
NUM_CLASSES = 47
PRETRAINED  = True
SAVE_PATH   = f"./checkpoints/{time.strftime('%Y%m%d-%H%M%S', time.localtime())}-maxvit_tiny"
...
if __name__ == "__main__":
    ...
    # dataset
    _, _, _, train_dataloader, val_dataloader, test_dataloader  = get_torchvision_cls_dataset('DTD', BATCH_SIZE, resize=RESIZE, transform_mode="Inception", root="./datasets")

    # model
    model = models.maxxvit.maxvit_tiny_rw_224(pretrained=True, num_classes=NUM_CLASSES)
