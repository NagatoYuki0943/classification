...
NUM_CLASSES = 6
PRETRAINED  = True
SAVE_PATH   = f"./checkpoints/{time.strftime('%Y%m%d-%H%M%S', time.localtime())}-shufflenet_v2_x1_0"
...
if __name__ == "__main__":
    ...
    # dataset
    _, _, train_dataloader, val_dataloader = get_custom_data("datasets/intel_origin_scenery", batch_size=BATCH_SIZE, resize=RESIZE)
