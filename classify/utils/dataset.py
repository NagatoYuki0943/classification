...
#---------------------------------------------#
def show_3_channels():
    train_dataset, val_dataset, train_dataloader, val_dataloader = get_custom_data("./datasets/scenery", 24, 128)
    ...
    target_list = [idx_to_cls[int(target)] for target in target_list]   # target id to name
