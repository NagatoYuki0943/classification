...
def get_data(data_dir = r"C:\Ai\\Garbage50\data\\", batch_size = 8, resize = 224, num_workers=0):
    '''
    获取数据集
    '''
    ...
    dataloaders    = {x: DataLoader(image_datasets[x], batch_size=batch_size, shuffle=True, num_workers=num_workers) for x in ['train', 'valid']}
